...
if S then
    game.StarterGui:SetCore("SendNotification", {
        Title = "Silent Aim",
        Text = "Silent Aim was Enabled, Mode: BounceBot",
        Duration = 5
    })
...
if game.PlaceId == 4923146720 then
    return game:GetService("StarterGui"):SetCore("SendNotification", {
        Title = "Error",
        Text = "BounceBot can't be used in Playground LEAVE",
        Duration = 5,
        Button1 = "Ok"
    })
end
...
_G.InputBegan = UIS.InputBegan:Connect(function(Key, GPE)
    if not GPE and Key.KeyCode == Enum.KeyCode.Z and Player.Character and Player.Character:FindFirstChild("Basketball") and IsInFooting then
